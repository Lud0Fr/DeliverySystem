...
{
    public class CancelDeliveryCommandHandlerTest
    {
        ...
        public CancelDeliveryCommandHandlerTest()
        {
        ...
        private CancelDeliveryCommand NewCancelDeliveryCommand()
        {
            return new CancelDeliveryCommand(1);
        }
    }
}
