...
{
    public class ApproveDeliveryCommandHandlerTest
    {
        ...
        public ApproveDeliveryCommandHandlerTest()
        {
        ...
        public async Task Handle_Uses_GetAsync_From_IDeliveryRepository_To_Get_The_Delivery()
        {
            ...
            var sut = new ApproveDeliveryCommandHandler(
                _deliveryRepository.Object,
                _existsDelivery.Object,
                _userContext.Object,
                _unitOfWork.Object);
            // Act
            await sut.Handle(NewApproveDeliveryCommand(), new CancellationToken());
            // Assert
        ...
        [Fact]
        public async Task Handle_Uses_Update_From_IDeliveryRepository_With_Delivery_State_Is_Approved()
        {
            // Arrange
            Arrange();
            ...
            await sut.Handle(NewApproveDeliveryCommand(), new CancellationToken());
            // Assert
            _deliveryRepository.Verify(r => r.Update(It.Is<Delivery>(d => d.State == DeliveryState.Approved)), Times.Once);
        }
        ...
        private ApproveDeliveryCommand NewApproveDeliveryCommand()
        {
            return new ApproveDeliveryCommand(1);
        }
    }
}
